        ...
        <div class="form-container">
            <form action="${pageContext.request.contextPath}/user-profile" method="post">
                ...
                <div class="input-name">
                    ...
                    <input type="text" placeholder="Business Name" class="number" name="businessName" value="<%= (request.getParameter("businessName") != null) ? request.getParameter("businessName") : user.getBusinessName() %>">
                </div>

                <div class="input-name">
                    <i class="fa-solid fa-location-pin phoneNumber"></i>
                    <input type="text" placeholder="Address" class="number" name="address" value="<%= (request.getParameter("address") != null) ? request.getParameter("address") : user.getAddress() %>">
                </div>
